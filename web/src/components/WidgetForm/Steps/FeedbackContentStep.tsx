    ...
    return(
        ...
        <header>
            ...
            <span className="text-xl leading-6 flex  items-center gap-2">
                <img src={feedbackTypeInfo.image.source} alt={feedbackTypeInfo.image.alt} className="w-6 h-6 flex "/>
       ...
       <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
           <textarea
            className="min-w-[304px] w-full min-h[112px] text-sm placeholder-zinc-400 text-zinc-100 bg-transparent border-1 border-zinc-600 rounded-md focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none resize-none Scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
